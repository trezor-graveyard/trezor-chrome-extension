...
module.exports.TREZOR_DESC = {
  vendorId: 0x534c,
  productId: 0x0001
};

module.exports.HEADER_SIZE =  1 + 1 + 4 + 2; //should be 8 :-)
module.exports.MESSAGE_HEADER_BYTE = 0x23; 
module.exports.BUFFER_SIZE = 63;
module.exports.REPORT_ID = 63;

module.exports.LISTEN_ITERS = 60;
module.exports.LISTEN_DELAY = 500;


module.exports.SATOSHI_KEYS = [
